...
//               <td>
//                 <div>
//                   <button type="button" onClick={() =>  removeProductsInCart(item)}>
//                       <img src={minusImg} alt="Remover quantidade" />
//                   </button>
//                    <span>{`${item.qtd}`.padStart(2, '0')}</span>
//                    <button type="button" onClick={() => addAndEditProductsInCart(item)}>
//                       <img src={plusImg} alt="Adicionar quantidade" />
//                    </button>
//                 </div>
//               </td>
//               <td>
//                 {!item.blackFriday && <h5>{currencyFormat(item.price * item.qtd)}</h5>}
//                 {item.blackFriday && <h5>{currencyFormat(item.price * (100 - item.discount) / 100 * item.qtd)}</h5>}
//               </td>
//               <td>
